...
#include "detection_msgs/msg/detail/detection2_d_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const detection_msgs::msg::Detection2D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  detection_msgs::msg::Detection2D &);
size_t get_serialized_size(
  const detection_msgs::msg::Detection2D &,
  size_t current_alignment);
size_t
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: detections
  {
    ...
    for (size_t i = 0; i < size; i++) {
      detection_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  detection_msgs::msg::Detection2DArray & ros_message)
{
  ...
  // Member: detections
  {
    ...
    for (size_t i = 0; i < size; i++) {
      detection_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        detection_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        detection_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection2D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = detection_msgs::msg::Detection2DArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: detections
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      detection_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.detections[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        detection_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.detections[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        detection_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Detection2D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const detection_msgs::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<detection_msgs::msg::Detection2DArray *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_detection_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<detection_msgs::msg::Detection2DArray>()
{
  return &detection_msgs::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
