...
bool detection_msgs__msg__detection2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("detection_msgs.msg._detection2_d.Detection2D", full_classname_dest, 44) == 0);
  }
  detection_msgs__msg__Detection2D * ros_message = _ros_message;
  {  // x_min
...
PyObject * detection_msgs__msg__detection2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("detection_msgs.msg._detection2_d");
